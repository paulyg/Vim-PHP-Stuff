...
" curl
syn keyword phpFunctions curl_init curl_copy_handle curl_version curl_setopt curl_setopt_array curl_exec curl_getinfo curl_error curl_errno curl_close curl_multi_init curl_multi_add_handle curl_multi_remove_handle curl_multi_select curl_multi_exec curl_multi_getcontent curl_multi_info_read curl_multi_close curl_escape curl_file_create curl_multi_setopt curl_multi_sterror curl_pause curl_reset curl_share_close curl_share_init curl_share_setopt curl_sterror curl_unescape contained
...
syn keyword phpClasses DateTime DateTimeZone DateInterval DatePeriod DateTimeImmutable DateTimeInterface contained
...
" hash
syn keyword phpFunctions hash hash_file hash_hmac hash_hmac_file hash_init hash_update hash_update_stream hash_update_file hash_final hash_copy hash_algos mhash_keygen_s2k mhash_get_block_size mhash_get_hash_name mhash_count mhash hash_pbkdf2 contained
...
" Language Constructs
syn keyword phpStatement die exit eval empty isset unset list instanceof insteadof yield contained
